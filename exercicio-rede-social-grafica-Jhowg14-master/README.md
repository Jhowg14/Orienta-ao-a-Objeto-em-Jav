[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8219874&assignment_repo_type=AssignmentRepo)
# Rede Social Gráfica
...
poderia ser feito uma exceçao em que um método que retorna uma mensagem de erro, caso o identificador da mensagem não exista.
POderia alterar o tipo de retorno do método.Dessa forma, a classe cliente pode tratar o retorno do método de forma apropriada.
Métodos que retornem um objeto, podem fazer a mesma abordagem retornando null caso o
método tenha alguma falha (assim a classe cliente poderia utilizar esse retorno).
• mas como tratar erros em construtores, já que não possuem retorno?
• Como tratar métodos para os quais um retorno false ou null são
retornos válidos e não erros.
• Ex: método para procurar um elemento por uma chave.
• Isso sem contar que a classe cliente poderia, simplesmente, ignorar o
retorno do método.
...
O programa ira lançar uma exceção e deverá exibir uma mensagem para o usuário de que o ID não existe e continue pedindo o identificador para o usuário até ele digitar um identificador válido.
