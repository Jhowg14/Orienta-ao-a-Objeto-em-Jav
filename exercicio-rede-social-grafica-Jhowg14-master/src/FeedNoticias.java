...
public class FeedNoticias {
    ...
    //Altere a classe FeedNoticias para que ela tenha uma lista com os autores das mensagens
    ...
    // crie uma sobrecarga do método getPublicacoes que recebe um autor por parâmetro e retorna apenas as mensagens dele.
    ...
    public void curtir(int idMensagem) {
        //lance uma exceção caso o identificador da mensagem não exista (use exceção do tipo `RuntimeException`).
        if(idMensagem > mensagens.size()){
