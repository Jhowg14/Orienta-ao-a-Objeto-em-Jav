...
public class Tela {
    ...
    private void criarCompetidores() {
        ...
        Competidor comp1 = new Corredor("Jhon", 2);
        Competidor comp2 = new Corredor("Joao", 4);
        Competidor comp3 = new Corredor("Julia", 3);
        competidores.add(comp1);
        competidores.add(comp2);
        competidores.add(comp3);
