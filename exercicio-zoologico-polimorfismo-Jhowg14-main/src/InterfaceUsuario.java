...
public class InterfaceUsuario {
    ...
    private void cadastrarAnimal() {
        ...
        Boolean voa = Boolean.parseBoolean(pedirString("O animal voa? (true/false)"));
        
        if(voa){
            String Tipo = pedirString("Qual o animal?\n Galinha: G\n Aguia: A \n");
            String qualidadeVoo = pedirString("Digite a qualidade do voo do animal");
            if(Tipo.equals("G")){
                zoologico.cadastrarGalinha(nome, qualidadeVoo);
            }else if(Tipo.equals("A")){
                zoologico.cadastrarAguia(nome, qualidadeVoo);
            }
        }else{
            String Tipo = pedirString("Qual o animal?\n Lobo: L\n Gato: G \n");
            String cor = pedirString("Digite a cor do pelo do animal");
            if(Tipo.equals("L")){
    ...
    private void descreverAnimal() {
        ...
        //caso o animal não exista, exibe mensagem de erro
        if(zoologico.getDescricaoAnimal(nome) != null){
           System.out.println( zoologico.getDescricaoAnimal(nome));
        }else{
    ...
    private void listarAnimaisCompleto() {
        // implemente seu código aqui.
        System.out.println( zoologico.listarAnimaisLonga());
    }
}